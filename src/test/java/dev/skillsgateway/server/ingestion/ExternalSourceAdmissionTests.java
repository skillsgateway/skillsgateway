...
/**
 * Configuration-gated admission (GW_INGEST_0020) as the pure function it is: the same source run through
...
class ExternalSourceAdmissionTests {
    ...
    void the_shipped_default_admits_nothing() {
        ...
        // GW_INGEST_0003's phrase survives: an unconfigured gateway records exactly what it always did.

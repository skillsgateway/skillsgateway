...
/**
 * Reconciles the declared estate at startup (GW_ESTATE_0001): {@code afterSingletonsInstantiated} runs
 ...
 * reported, never fatal (GW_ESTATE_0005); an infrastructure failure still fails startup.
 */
@Component

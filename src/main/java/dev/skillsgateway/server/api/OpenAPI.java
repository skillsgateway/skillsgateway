...
public class OpenAPI {
     ...
     *
     * <p>Generated by looping {@link WebhookEvent#ALL} rather than written as eight
     * {@code @Webhook} annotations: an event added to the registry cannot then fail to appear in
     * the contract, which is the drift this exists to close. {@link WebhookEvent#AUDIT_EXPORT} stays

...
/**
 * The persisted closure of a composite snapshot (GW_INGEST_0030.4). Insert and read only: a closure is
...
public class SnapshotClosureRepository {
     ...
     */
    @Requirements({"GW_INGEST_0030.1", "GW_INGEST_0030.3"})
    ...
    @Requirements({"GW_INGEST_0030.1", "GW_INGEST_0030.4"})

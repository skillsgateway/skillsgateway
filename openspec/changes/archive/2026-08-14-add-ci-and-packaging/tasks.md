...
- [x] 1.1 Add GW_RELEASE_0001 (container distribution, implementation: configuration) to docs/reqstool/requirements.yml
- [x] 1.2 Add SVC_GW_RELEASE_0001 (automated packaging-consistency test) to docs/reqstool/software_verification_cases.yml
...
## 3. Container packaging (SVC_GW_RELEASE_0001)
...
- [x] 3.3 Add PackagingTests with @SVCs(SVC_GW_RELEASE_0001) validating Dockerfile/chart/compose consistency
- [x] 3.4 Add compose.yaml for local run of the image with PostgreSQL; document in README

## 4. Helm chart (SVC_GW_RELEASE_0001)

...
shipped-unscanned (SVC_GW_VETTING_0024, SVC_GW_VETTING_0026); `pending` blocks (SVC_GW_VETTING_0027); and
the fail-closed matrix (SVC_GW_VETTING_0025) — unreachable, non-2xx, read timeout, empty,
...
```
target/generated-sources/annotations/resources/annotations.yml:      GW_VETTING_0024..GW_VETTING_0027
target/generated-test-sources/test-annotations/resources/annotations.yml: SVC_GW_VETTING_0024..SVC_GW_VETTING_0027
```

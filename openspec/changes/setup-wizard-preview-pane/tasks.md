...
- [x] 1.1 Add GW_0079–GW_0082 to `docs/reqstool/requirements.yml`
      ...
      in-flight changes.
- [x] 1.2 Add SVC_GW_0079–SVC_GW_0082 to
...
- [x] 4.1 `PreviewTests` (SVC_GW_0080): tree lists the pinned commit's paths;
...
- [x] 4.2 `PreviewTests` (SVC_GW_0081): approve, advance upstream
...
- [x] 5.5 Playwright e2e: wizard spec (SVC_GW_0079) and preview/diff spec

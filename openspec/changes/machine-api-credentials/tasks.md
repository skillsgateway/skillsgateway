...
- [x] 1.1 Author GW_0126–GW_0131 in `docs/reqstool/requirements.yml` — title,
      significance, description, rationale, categories, revision — as the only
      place their text exists.
- [x] 1.2 Author SVC_GW_0126–SVC_GW_0131 in
      `docs/reqstool/software_verification_cases.yml`, each naming the
      verification it demands.
- [x] 1.3 Confirm no other branch has claimed GW_0126–GW_0131 before pushing.

...
- [x] 1.1 Write the executable spec to `spec-approval.md` (named test list for
  GW_VETTING_0024–GW_VETTING_0027, negative constraints, setup plan, no new dependencies).
...
- [x] 2.1 Add GW_VETTING_0024–GW_VETTING_0027 to `docs/reqstool/requirements.yml`.
- [x] 2.2 Add SVC_GW_VETTING_0024–SVC_GW_VETTING_0027 to `software_verification_cases.yml`.
- [x] 2.3 Confirm GW_VETTING_0024–GW_VETTING_0027 unused elsewhere (GW_FACADE_0015–GW_AUTH_0028 are claimed by
...
- [x] 5.1 `ExternalVettingConnectorUnitTests` (pure, container-free): happy paths,
  ...
  matrix (GW_VETTING_0024–GW_VETTING_0027). 20 tests.
- [x] 5.2 `ExternalVettingConnectorTests` (integration, real `VettingService` over
  ...
  fail-closed matrix leaves the snapshot held. Carries SVC_GW_VETTING_0024–0145.
